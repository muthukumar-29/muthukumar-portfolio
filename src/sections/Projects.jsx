...
const projects = [
  ...
  },
  {
    ...
    description: 'Automated WhatsApp messaging system for Krish Homestays that handles guest inquiries, booking confirmations, and follow-ups using NLP-powered responses and n8n workflow orchestration.',
    tech: ['WhatsApp API', 'n8n', 'Javascript', 'OpenAI', 'Google Sheets'],
  ...
  },
  {
    ...
    description: 'Facebook Messenger bot with NLP-powered intent detection, automated response flows, real-time session management via Google Sheets, and n8n as the orchestration backbone — deployed for Krish Homestays.',
    tech: ['Facebook API', 'n8n', 'Javascript', 'OpenAI', 'Google Sheets'],
    category: 'AI Automation',
    color: '#00FFB2',
    github: '#',
