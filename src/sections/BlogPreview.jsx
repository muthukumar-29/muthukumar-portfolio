      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        {featured.map((post, i) => (
          ...
          >
            <Link
              to={`/blog/${post.slug}`}
              className={`flex flex-col justify-between w-full h-full rounded-2xl border overflow-hidden transition-all duration-500 group ${
                darkMode
            ...
            >
              {/* Color top accent */}
              <div className="h-1 flex-shrink-0" style={{ background: `linear-gradient(90deg, ${post.color}, ${post.color}80)` }} />
